...
(function(angular) {
    ...
    [
        ...
        if ($attrs.popoverType === undefined || $attrs.popoverType == 1) {
            ...
            $attrs.sspTooltip = "'ssp/ssp-tooltip/templates/tooltipType01.html'";
        } else if ($attrs.popoverType == 2) {
            //popover with image and message over colored background
            $scope.popover.message = $attrs.sspTooltip;
            $attrs.popoverClass = "popoverType2";
            $attrs.sspTooltip = "'ssp/ssp-tooltip/templates/tooltipType02.html'";
            ...
            $attrs.sspTooltip = "'ssp/ssp-tooltip/templates/tooltipType03.html'";
        } else {
