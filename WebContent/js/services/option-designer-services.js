    ...
    this.getContainers = function() {
        ...
        const mockData = [
            ...
            },
            {
                ...
                "src"             : "http://placehold.it/32x32/F7D08A",
                "renderOptions"   : [
                	{ctype: 'rect', left: 0, top: 0, width: gridSpacing * 6, height: gridSpacing * 1, fill: '#e3e3e3', stackable: true, subtype: 'header'},
                	{ctype: 'textbox', left: 2, top: 5, width: gridSpacing * 6 - 4, fontSize: 10, fontWeight: 'bold', text: '${contestHeader.text.EN}', 
                    	textAlign: 'center', customData: {display: 'Contest group header', contentType: 'header'}},
                    	
                	{ctype: 'rect', left: 0, top: gridSpacing * 1, width: gridSpacing * 6, height: gridSpacing * 3, fill: '#ffffff', stackable: true, subtype: 'header'},
                	{ctype: 'rect', left: 0, top: gridSpacing * 1, width: gridSpacing * 3, height: gridSpacing * 3, fill: '#000000', stackable: true, 
                		customData: {display: 'Contest title', contentType: 'title'}},
                		
                    {ctype: 'rect', left: 0, top: gridSpacing * 4, width: gridSpacing * 6, height: gridSpacing * 3, fill: '#ffffff', stackable: true, subtype: 'title'},
                    {ctype: 'rect', left: gridSpacing * 3, top: gridSpacing * 4, width: gridSpacing * 3, height: gridSpacing * 3, fill: '#000000', stackable: true, 
                		customData: {display: 'Template instructions', contentType: 'instructions'}},
                    	
                    {ctype: 'rect', left: 0, top: gridSpacing * 7, width: gridSpacing * 6, height: gridSpacing * 2,
                        fill: "#ffffff", stackable: true, subtype: "ballotOption"},
                    {ctype: 'rect', left: 0, top: gridSpacing * 9, width: gridSpacing * 6, height: gridSpacing * 2, 
                        fill: "#ffffff", stackable: true, subtype: "writeIn"},
                    {ctype: 'mark', left: 0, top: gridSpacing * 7, width: gridSpacing, height: gridSpacing, subtype: "mark", markStyle: "Oval"},
                    {ctype: 'textbox', left: (gridSpacing * 1) + 2, top: gridSpacing * 7 + 5, width: gridSpacing * 5 - 4, 
                    	fontSize: 10, fontWeight: 'bold', text: '${nomination.ballotName}',
                    	customData: {display: 'Candidate name', contentType: 'candidate'}},
                    {ctype: 'textbox', left: (gridSpacing * 1) + 2, top: gridSpacing * 8, width: gridSpacing * 5 - 4, 
                		fontSize: 10, text: '${party.name.EN}',
                    	customData: {display: 'Party name', contentType: 'party'}},
                    {ctype: 'separationLine', left: gridSpacing, top: gridSpacing * 9 - 5, width: gridSpacing * 5 - 1, 
                        stroke: "rgb(0,0,0)", strokeWidth:1, subtype: "separationLine"},
                    {ctype: 'mark', left: 0, top: gridSpacing * 9, width: gridSpacing, height: gridSpacing, subtype: "mark", markStyle: "Oval"},
                    {ctype: 'textbox', left: (gridSpacing * 1) + 2, top: gridSpacing * 9 + 5, width: gridSpacing * 5 - 4, 
                		fontSize: 10, fontWeight: 'bold', text: '${writeIn.name.EN}',
                    	customData: {display: 'Write-in text', contentType: 'writeIn'}},
                    {ctype: 'separationLine', left: gridSpacing, top: gridSpacing * 11 - 5, width: gridSpacing * 5 - 1, 
                        stroke: "rgb(0,0,0)", strokeWidth:1, subtype: "separationLine"}
                ],
                "backgroundColor" : "#F7D08A"
            },
            ...
            },
            {
                ...
                "src"             : "http://placehold.it/32x32/F7D08A",
                "renderOptions"   : [
                	{ctype: 'rect', left: 0, top: 0, width: gridSpacing * 8, height: gridSpacing * 1, fill: '#e3e3e3', subtype: 'header'},
                	{ctype: 'textbox', left: 2, top: 5, width: gridSpacing * 8 - 4, fontSize: 12, fontWeight: 'bold', text: '${contestHeader.text.EN}', 
                    	textAlign: 'center', customData: {display: 'Contest group header', contentType: 'header'}},
                    {ctype: 'rect', left: 0, top: gridSpacing * 1, width: gridSpacing * 8, height: gridSpacing * 1, fill: "#f8f8f8", subtype: 'title'},
                    ...
                    {ctype: 'textbox', left: 2, top: (gridSpacing * 2) + 5, width: gridSpacing * 8 - 4, fontSize: 12, fontWeight: 'bold', 
                    ...
                    {ctype: 'textbox', left: 2, top: (gridSpacing * 3) + 5, width: gridSpacing * 8 - 4, fontSize: 12,  
                        text: '${contest.contestAbstract.EN}', customData: {display: 'Template contents', contentType: 'contents'}},
                    {ctype: 'rect', left: 0, top: gridSpacing * 4, width: gridSpacing * 8, height: gridSpacing * 1, 
                        fill: "#ffffff", subtype: "ballotOption"},
                    {ctype: 'mark', left: 0, top: gridSpacing * 4, width: gridSpacing, height: gridSpacing, subtype: "mark", markStyle: "Circle"},
                    {ctype: 'textbox', left: (gridSpacing * 1) + 2, top: gridSpacing * 4 + 4, width: gridSpacing * 7 - 4, fontSize: 12, fontWeight: 'bold', 
                        text: '${nomination.name.EN}', customData: {display: 'Candidate name', contentType: 'candidate'}},
                    {ctype: 'separationLine', left: gridSpacing, top: gridSpacing * 5 - 5, width: gridSpacing * 7 - 1, 
                        stroke: "rgb(0,0,0)", strokeWidth:1, subtype: "separationLine"}
                ],
                "backgroundColor" : "#F7D08A"
